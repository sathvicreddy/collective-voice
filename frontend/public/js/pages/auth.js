...
export async function authForgot() {
  // Use the stable ID selector — same as authSubmit uses for consistency
  const emailEl = document.querySelector("#authEmail") || document.querySelector("input[type='email']");
  const email = emailEl?.value.trim();
  if (!email) { _showAuthError("Please enter your email."); emailEl?.focus(); return; }
  try {
    ...
    <div class="landing-desktop" id="landing-top">
      ...
      <nav class="landing-nav" id="landing-nav">
        ...
        <div class="landing-nav-links" id="landing-nav-links">
          <button type="button" class="landing-nav-link" id="nav-link-how" data-action="scrollToSection" data-section="how-it-works">How It Works</button>
          <button type="button" class="landing-nav-link" id="nav-link-features" data-action="scrollToSection" data-section="features">Features</button>
          <button type="button" class="landing-nav-link" id="nav-link-events" data-action="scrollToSection" data-section="for-events">For Events</button>
          <button type="button" class="landing-nav-link" id="nav-link-about" data-action="scrollToSection" data-section="about">About Us</button>
        </div>
        <div class="landing-nav-actions">
          <button type="button" class="landing-nav-login" id="landing-login-btn" data-action="go" data-route="/login">Log in</button>
          <button type="button" class="landing-nav-cta" id="landing-cta-btn" data-action="go" data-route="/signup">Get Started <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
          <button type="button" class="landing-hamburger" id="landing-hamburger" data-action="toggleLandingMenu" aria-label="Menu">
      ...
      <div class="landing-mobile-menu" id="landing-mobile-menu">
        <button type="button" class="landing-mobile-link" data-action="scrollToSection" data-section="how-it-works">How It Works</button>
        <button type="button" class="landing-mobile-link" data-action="scrollToSection" data-section="features">Features</button>
        <button type="button" class="landing-mobile-link" data-action="scrollToSection" data-section="for-events">For Events</button>
        <button type="button" class="landing-mobile-link" data-action="scrollToSection" data-section="about">About Us</button>
        <hr style="border:none;border-top:1px solid #e8e0ff;margin:8px 0">
        <button type="button" class="landing-mobile-link" data-action="go" data-route="/login">Log in</button>
        <button type="button" class="landing-mobile-link primary" data-action="go" data-route="/signup">Get Started</button>
      </div>
      ...
      <div class="landing-hero">
        ...
        <div class="landing-hero-left">
          ...
          <div class="landing-hero-btns">
            <button type="button" class="landing-btn-primary" id="hero-create-btn" data-action="landingCreateMeeting">
              Create a Meeting
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:16px;height:16px"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            </button>
            <button type="button" class="landing-btn-outline" id="hero-join-btn" data-action="go" data-route="/join">
              Join a Meeting
        ...
        <div class="ls-container">
          ...
          <div class="ls-events-grid">
            ...
            <div class="ls-event-card ls-event-card--conf">
              ...
              <button type="button" class="ls-event-btn" data-action="go" data-route="/signup">Host Your First Event →</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="ls-footer-cta">
        ...
        <div class="ls-footer-cta-btns">
          <button type="button" class="landing-btn-primary" id="footer-create-btn" data-action="landingCreateMeeting">Create Free Account <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:16px;height:16px"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></button>
          <button type="button" class="ls-footer-ghost-btn" id="footer-join-btn" data-action="go" data-route="/join">Join as Guest</button>
        </div>
        <div class="ls-footer-links">
          <span class="ls-footer-link">© 2026 CollectiveVoice</span>
          <button type="button" class="ls-footer-link" data-action="scrollToSection" data-section="how-it-works" style="background:none;border:none;cursor:pointer;font:inherit">How It Works</button>
          <button type="button" class="ls-footer-link" data-action="scrollToSection" data-section="features" style="background:none;border:none;cursor:pointer;font:inherit">Features</button>
          <button type="button" class="ls-footer-link" data-action="scrollToSection" data-section="for-events" style="background:none;border:none;cursor:pointer;font:inherit">For Events</button>
          <button type="button" class="ls-footer-link" data-action="scrollToSection" data-section="about" style="background:none;border:none;cursor:pointer;font:inherit">About Us</button>
        </div>
      </div>
    </div>
    ...
    <div class="mobile-welcome">
      ...
      [icons.shield, "Secure & private", "Your data is always protected"]
        ...
        <div class="mobile-welcome-actions">
          <button type="button" class="mobile-welcome-btn-primary" id="mobile-login-btn" data-action="go" data-route="/login">Log In</button>
          <button type="button" class="mobile-welcome-btn-secondary" id="mobile-signup-btn" data-action="go" data-route="/signup">Sign Up</button>
          <!-- Guest → /join lets them enter a meeting code without requiring data to be loaded -->
          <button type="button" class="mobile-welcome-btn-ghost" id="mobile-guest-btn" data-action="go" data-route="/join">Continue as Guest</button>
        </div>
      </div>
    </div>
  `;
  ...
  app.innerHTML = `
        ...
        <div class="auth-right-inner">
          ...
          <form class="auth-form" data-submit="authSubmit">
            ...
            <div class="auth-social-row">
              <button type="button" class="auth-social-btn" id="googleBtn" data-action="oauth" data-provider="google">
    ...
    <div class="mobile-auth">
      <div class="mobile-auth-header">
        <button type="button" class="mobile-auth-back" data-action="go" data-route="/welcome">${icons.arrowLeft}</button>
      ...
      <div class="mobile-auth-body">
        ...
        <form class="mobile-auth-form" data-submit="authSubmit">
          ...
          <button type="submit" class="auth-submit-btn" id="mobileAuthSubmit">
            ${isSignup ? "Create Account" : "Log in"}
          </button>
...
export function renderOnboarding(step = 1) {
  ...
  app.innerHTML = `
    <div class="mobile-auth" style="justify-content:center;align-items:center;text-align:center">
      ...
      ? `<button type="button" class="auth-submit-btn" data-action="go" data-route="/onboarding/${index + 2}">Next</button>`
      : `<button type="button" class="auth-submit-btn" data-action="go" data-route="/login">Get Started</button>`}
          <button type="button" class="auth-switch-link" data-action="go" data-route="/home" style="padding:12px">Skip</button>
        </div>
      </div>
    </div>
  `;
...
export function renderForgot() {
  app.innerHTML = `
    <div class="mobile-auth">
      <div class="mobile-auth-header">
        <button type="button" class="mobile-auth-back" data-action="go" data-route="/login">${icons.arrowLeft}</button>
        <div class="mobile-auth-logo">
          <div class="mobile-auth-mark">${icons.mic}</div>
          <span>Collective<b>Voice</b></span>
        </div>
      ...
      <div class="mobile-auth-body">
        ...
        <form class="mobile-auth-form" data-submit="authForgot">
          ...
          <p class="auth-switch">
            ...
            <button type="button" class="auth-switch-link" data-action="go" data-route="/login">Log in</button>
          </p>
        </form>
      </div>
    </div>
    ...
    <div class="mobile-auth">
      ...
      : `<p class="mobile-auth-sub" style="color:#e54040">⚠️ Invalid or expired reset link. Please request a new one.</p>`
        ...
        <form class="mobile-auth-form" id="reset-form" data-submit="authReset">
          ...
          <button type="submit" class="auth-submit-btn" ${!hasToken ? "disabled" : ""}>Reset Password</button>
          ` : `
          <button type="button" class="auth-submit-btn" data-action="go" data-route="/forgot">Request New Reset Link</button>
          `}
        </form>
      </div>
    </div>
