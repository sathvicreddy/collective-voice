        ...
        <div class="auth-right-inner">
          ...
          <div class="auth-form">
            ...
            <div class="auth-social-row">
              ...
              <button class="auth-social-btn" id="microsoftBtn" disabled>
                <svg viewBox="0 0 24 24" width="18" height="18">
              ...
              <button class="auth-social-btn" id="githubBtn" disabled>
      ...
      <div class="mobile-auth-body">
        ...
        <div class="mobile-auth-form">
          ...
          <div class="auth-social-row">
            ...
            <button class="auth-social-btn" id="mobile-microsoft-btn" disabled>
            ...
            <button class="auth-social-btn" id="mobile-github-btn" disabled>
