        ...
        <div class="auth-right-inner">
          ...
          <div class="auth-form">
            ...
            <div class="auth-social-row">
              ...
              <button type="button" class="auth-social-btn" id="microsoftBtn" onclick="alert('Microsoft authentication is not currently set up.'); return false;">
                <svg viewBox="0 0 24 24" width="18" height="18">
              ...
              <button type="button" class="auth-social-btn" id="githubBtn" onclick="alert('GitHub authentication is not currently set up.'); return false;">
      ...
      <div class="mobile-auth-body">
        ...
        <div class="mobile-auth-form">
          ...
          <div class="auth-social-row">
            ...
            <button type="button" class="auth-social-btn" id="mobile-microsoft-btn" onclick="alert('Microsoft authentication is not currently set up.'); return false;">
            ...
            <button type="button" class="auth-social-btn" id="mobile-github-btn" onclick="alert('GitHub authentication is not currently set up.'); return false;">
